...
const createPairProgrammingUseCase = new CreatePairProgrammingUseCase(pairProgrammingRepository,
      problemRespository, notificationSocket,
...
const arenaController = new ArenaController(createChallengeUseCase,
      joinChallengeUseCase, createPairProgrammingUseCase,
      joinPairProgarmmingUseCase, activePrivateChallengeUsecase,
      activePublicChallengeUsecase, getUserRepositoryDataUseCase,
      updateChallengeRepositoryDataUseCase, getChallengeDataUseCase,
      endChallengeUseCase, challengeResultsUseCase, leaderBoardUseCase
)
const submissionController = new SubmissionController(getAllSubmissionByProblemuseCase,
      getAllUsersSubmissionUseCase, getRecentSubmissionUseCase,
      getProblemDataUseCase, submitProblemUseCase, runProblemUseCase
)
